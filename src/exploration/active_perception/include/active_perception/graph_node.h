...
public:
  ...
  ViewNode(const Vector3d& p, const double& pit, const double& y);
  ViewNode() {
  }
  ~ViewNode() {
  }
  ...
  static double computeCost(const Vector3d& p1, const Vector3d& p2, const double& pit1, const double& pit2, const double& y1, const double& y2,
  ...
  Vector3d pos_, vel_;
  double yaw_, yaw_dot_, pitch_, pitch_dot_;

  // Parameters shared among nodes
  static double vm_, am_, yd_, pd_, ydd_, w_dir_;
